...
class MovieController extends ApiController
{
    ...
    */
    public function create(Request $request,  MovieRepository $movieRepository, EntityManagerInterface $em)
    {
        ...
        // validate the descripcion
        if (! $request->get('descripcion')) {
            return $this->respondValidationError('Please provide a descripcion!');
        }

        // validate the imagen
        if (! $request->get('imagen')) {
            return $this->respondValidationError('Please provide a imagen!');
        }
        ...
        $movie->setCount(0);
        $movie->setDescripcion($request->get('descripcion'));
